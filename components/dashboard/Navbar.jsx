...
export default function Sidebar({ session }) {
  ...
  const { email, name, role, image } = session?.user || {};

  return (
    <aside className="flex h-screen w-64 flex-col border-r border-white/10 bg-linear-to-b from-[#050816] via-[#0a0f2c] to-[#111827] p-4 shadow-2xl shadow-blue-950/30">
      {/* Logo */}
      <div className="flex items-center gap-3 border-b border-white/10 pb-5">
        ...
        <div>
          <h1 className="text-2xl font-bold tracking-wide text-white">LOOP</h1>
