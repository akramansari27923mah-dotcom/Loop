...
export default function Sidebar({ session }) {
  ...
  return (
    <>
      <aside
        className={`flex h-screen z-100 fixed top-0 left-0  flex-col ${openSidebar && "border-r"} border-white/10 bg-linear-to-b from-[#050816] via-[#0a0f2c] to-[#111827]  shadow-2xl shadow-blue-950/30 overflow-hidden transition-all duration-300`}
        style={{
          width: openSidebar ? "280px" : "0px",
